class ContactsController < ApplicationController
  ...
  def new
    @contact = Contact.new
    # Address.new para o formulário saber que tem um objeto endereço para preencher
  ...
  private
    # método para o select do formulário de contato com os tipos de contatos
    def set_listar_tipos_contatos
